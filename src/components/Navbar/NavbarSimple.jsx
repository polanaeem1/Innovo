  ...
  return (
    <ul className="my-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6 ">
      ...
      >
        <Link
          to="/"
          className="flex items-center hover:text-[#0B469E] transition-colors "
        >
          Home
        </Link>
      </Typography>
...
export function NavbarSimple() {
  ...
  return (
    <Navbar className="mx-auto w-full px-6 py-3 shadow-none">
      <div className="flex items-center justify-between text-blue-gray-900">
        <Typography
          as="a"
          href="#"
          variant="h6"
          className="mr-4 cursor-pointer py-1.5 text-[#0B469E]"
        >
          <svg
            version="1.0"
